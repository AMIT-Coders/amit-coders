...
const sections: Section[] = [
  ...
  },
  {
    ...
    <p className="text-1xl mb-2">Your use of our Services</p>
    <p className="text-1xl mb-2">
      Subject to your compliance with these Legal Terms, including the
      "PROHIBITED ACTIVITIES" section below, we grant you a non-exclusive,
      non-transferable, revocable license to:
    </p>
    <p className="text-1xl mb-2">access the Services; and</p>
    <p className="text-1xl mb-2">
    ...
    <p className="text-1xl mb-2">
      ...
      address your request to: info@amitcoders.org. If we
  ...
  <p className="text-1xl mb-2">As a user of the Services, you agree not to:</p>
  ...
  <p className="text-1xl mb-2">Your Contributions are not false, inaccurate, or misleading.</p>
  <p className="text-1xl mb-2">
  ...
  },
  {
    ...
    <p className="text-1xl mb-2">Binding Arbitration</p>
    <p className="text-1xl mb-2">
    ...
    <p className="text-1xl mb-2">Exceptions to Informal Negotiations and Arbitration</p>
    <p className="text-1xl mb-2">
