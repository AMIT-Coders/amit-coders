          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-10 max-w-xl text-base leading-7 text-gray-700">
              <p>
                ...
                dream to provide quality education that would change people's
                lives regardless of their background or social status, they
                believed in fair education for all.
              </p>
              <p className="mt-10">
              ...
              <p className="mt-10">
                We are on a mission to change people's lives, how are we doing
                that?, by introducing and educating people about tech and how it
                can change their lives by changing their careers.
              </p>
            </div>
          </div>
      ...
      <div className="mx-auto mt-8 max-w-7xl px-6 sm:mt-16 lg:px-8">
        <div className="mx-auto max-w-3xl lg:mx-0">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            AMIT's vision is to be a world leader in tech education, by making
            tech education more affordable and accessible for people from across
            the world, our vision is a world where work and life advances to
            make progress a constant in everyone's life, technology is advancing
            fast so should our environments, lives and work.
          </p>
        </div>
