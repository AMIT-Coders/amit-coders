...
const incentives = [
  {
    ...
    description: "Hands on Training. Online Live Instruction.",
  },
  {
    name: "Real World Projects",
    imageSrc:
      "https://tailwindui.com/img/ecommerce/icons/icon-warranty-simple.svg",
    description: "Project Base Learning. Real World Scenerios.",
  },
  {
    name: "Employment Services",
    imageSrc:
      "https://tailwindui.com/img/ecommerce/icons/icon-exchange-simple.svg",
    description: "Dedicated Career Coach. Life time Career Services.",
  },
];
